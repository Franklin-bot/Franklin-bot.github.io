  ...
  return (
    <div className='projects' id='projects'>
      ...
      <div className='projectsBody'>
        ...
        <Project imgURL={kubernetes} title="Image-based Sneaker Price Prediction" description="Developed a neural network to predict sneaker resell prices based on sneaker images, leveraging the direct correlation between design and price.
